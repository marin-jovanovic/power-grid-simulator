...
import py.simulator.protocols.iec104.slave
import py.simulator.protocols.modbus.server
import py.simulator.simulation
...
async def async_main(conf):
    ...
    simulation = await py.simulator.simulation.create_simulation(conf['process'])
    ...
    for server_conf in conf['communication']:
        ...
        fn = {
            'iec104': py.simulator.protocols.iec104.slave.create,
            'modbus': py.simulator.protocols.modbus.server.create,
        }[server_conf['type']]
